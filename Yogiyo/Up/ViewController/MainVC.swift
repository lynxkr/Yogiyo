...
class MainVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        imageview1.leadingAnchor.constraint(equalTo: scrollAdView.contentLayoutGuide.leadingAnchor).isActive = true
        imageview1.topAnchor.constraint(equalTo: scrollAdView.contentLayoutGuide.topAnchor).isActive = true
        ...
        imageview2.topAnchor.constraint(equalTo: scrollAdView.contentLayoutGuide.topAnchor).isActive = true
        ...
        imageview3.topAnchor.constraint(equalTo: scrollAdView.contentLayoutGuide.topAnchor).isActive = true
        imageview3.bottomAnchor.constraint(equalTo: scrollAdView.bottomAnchor).isActive = true
        imageview3.trailingAnchor.constraint(equalTo: scrollAdView.contentLayoutGuide.trailingAnchor).isActive = true
...
>>>>>>> dbf0700daed47e9c3cf194ff533a5e1f6500634e
